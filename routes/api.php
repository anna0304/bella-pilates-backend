...
Route::middleware(['auth:sanctum', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::put('/recorded-classes/{recordedClass}', [RecordedClassController::class, 'update']);
    Route::patch('/recorded-classes/{recordedClass}/deactivate', [RecordedClassController::class, 'deactivate']);
